        ...
        >
          <hr
            className={`w-[2.1875rem] h-[0.75rem] ${
              currentIndex === 0 ? `bg-[#6F91F4] opacity-100` : `opacity-0`
            } rounded-full`}
          />
          <hr
            className={`w-[2.1875rem] h-[0.75rem] ${
              currentIndex === 1 ? `bg-[#6F91F4] opacity-100` : `opacity-0`
            } rounded-full`}
          />
          <hr
            className={`w-[2.1875rem] h-[0.75rem] ${
              currentIndex === 2 ? `bg-[#6F91F4] opacity-100` : `opacity-0`
            } rounded-full`}
          />
          <hr
            className={`w-[2.1875rem] h-[0.75rem] ${
              currentIndex === 3 ? `bg-[#6F91F4] opacity-100` : `opacity-0`
            } rounded-full`}
          />
        </div>
      </div>
